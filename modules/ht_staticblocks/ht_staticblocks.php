...
class Ht_Staticblocks extends Module {
    ...
    public function hookdisplayFooterBefore() {
        if (!$this->isCached('module:ht_staticblocks/views/templates/hook/ht_staticblocks_footerbefore.tpl', $this->getCacheId('ht_staticblocks_footerbefore'))) {
        ...
        return $this->display(__FILE__, 'ht_staticblocks_footerbefore.tpl', $this->getCacheId('ht_staticblocks_footerbefore'));
    }
